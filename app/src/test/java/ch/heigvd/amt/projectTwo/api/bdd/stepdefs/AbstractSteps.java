...
import ch.heigvd.amt.projectTwo.api.bdd.CucumberTestContext;
...
public class AbstractSteps {
    ...
    protected void executePost(String apiPath, String authorization) {
        executePost(apiPath, null, null, authorization);
    }
    ...
    protected void executePost(String apiPath, Map<String, String> pathParams, Map<String, String> queryParamas, String authorization) {
        ...
        setAuthorization(authorization, request);
    ...
    protected void executeDelete(String apiPath, String authorization) {
        executeDelete(apiPath, null, null, authorization);
    }
    ...
    protected void executeDelete(String apiPath, Map<String, String> pathParams, Map<String, String> queryParams, String authorization) {
        final RequestSpecification request = CONTEXT.getRequest();
        final Object payload = CONTEXT.getPayload();
        final String url = baseUrl() + apiPath;
    ...
    protected void executePut(String apiPath, String authorization) {
        executePut(apiPath, null, null, authorization);
    }
    ...
    protected void executePut(String apiPath, Map<String, String> pathParams, Map<String, String> queryParams, String authorization) {
        final RequestSpecification request = CONTEXT.getRequest();
        final Object payload = CONTEXT.getPayload();
        final String url = baseUrl() + apiPath;
    ...
    protected void executePatch(String apiPath) {
        executePatch(apiPath, null, null, null);
    }

    protected void executePatch(String apiPath, String authorization) {
        executePatch(apiPath, null, null, authorization);
    }

    protected void executePatch(String apiPath, Map<String, String> pathParams) {
        executePatch(apiPath, pathParams, null, null);
    }

    protected void executePatch(String apiPath, Map<String, String> pathParams, Map<String, String> queryParams, String authorization) {
        final RequestSpecification request = CONTEXT.getRequest();
        final Object payload = CONTEXT.getPayload();
        final String url = baseUrl() + apiPath;
    ...
    protected void executeGet(String apiPath, String authorization) {
        executeGet(apiPath, null, null, authorization);
    }
    ...
    protected void executeGet(String apiPath, Map<String, String> pathParams, Map<String, String> queryParams, String authorization) {
        final RequestSpecification request = CONTEXT.getRequest();
        final String url = baseUrl() + apiPath;
    ...
    private void setAuthorization(String authorization, RequestSpecification request) {
